/* A playground for testing components, etc.
...
const DATA = [
  ...
  },
  {
    ...
    message: "Quantum flux excitement activating intermolecular rain-road attractions and exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum",
    receiver: "Adam",
    sender: "Yakub"
  },
  {
    id: "713a37a0-3d79-11ec-9bbc-0242ac130002",
    message: "Abdullah sent a maintenance request for his broken water heater. When are you fix it, and how much money do you want for it?",
    receiver: "Adam",
    sender: "Ilyas"
  },
  {
  ...
  },
  {
    ...
    message: "Arrived totally in as between public. Favour of so as on pretty though elinor direct. Reasonable estimating be alteration we themselves entreaties me of reasonably. Direct wished so be expect polite valley. Whose asked stand it sense no spoil to.",
    receiver: "Adam",
    sender: "Salman"
  },
  {
    id: "7a1203ee-3d79-11ec-9bbc-0242ac130002",
    message: "Assure polite his really and others figure though. Day age advantages end sufficient eat expression travelling. ",
    receiver: "Adam",
    sender: "Dawud"
  },
  {
